    ...
    <section className="py-24 bg-[#0a0a0f] relative" id="dealers">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-[10px] tracking-[0.5em] text-[#ffe600]/50 font-mono-cyber">// DEALER_PROGRAM</span>
          <h2 className="text-4xl md:text-5xl font-black text-white mt-4" style={{ fontFamily: 'Orbitron' }}>
            Become a <span className="text-[#39ff14]" style={{ textShadow: '0 0 20px rgba(57,255,20,0.3)' }}>Dealer</span>
          </h2>
        </div>
        ...
        <div className="mb-20">
          <h3 className="text-xl font-black text-white text-center mb-10" style={{ fontFamily: 'Orbitron', fontSize: '16px' }}>
            HOW TO <span className="text-[#00f0ff]">BECOME</span> A DEALER
          </h3>
        ...
        <div className="border border-[#39ff14]/20 p-8 md:p-12" style={{ background: 'rgba(57,255,20,0.03)', boxShadow: '0 0 30px rgba(57,255,20,0.05)' }}>
          <h3 className="text-lg font-black text-[#39ff14] mb-6" style={{ fontFamily: 'Orbitron', fontSize: '14px' }}>DEALER REQUIREMENTS</h3>
          <div className="grid md:grid-cols-3 gap-6">
            {['Active promotion and brand development in the region', 'Compliance with H2 ELEMENT standards and rules', 'Responsible approach to communication and application management'].map((req, i) => (

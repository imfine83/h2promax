    ...
    <section className="py-24 bg-[#0d0d1a] relative" id="benefits">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-[10px] tracking-[0.5em] text-[#00f0ff]/50 font-mono-cyber">// SYSTEM_BENEFITS</span>
          <h2 className="text-4xl md:text-5xl font-black text-white mt-4" style={{ fontFamily: 'Orbitron' }}>
            {b.heading} <span className="text-[#39ff14]" style={{ textShadow: '0 0 20px rgba(57,255,20,0.3)' }}>20–65%</span>
          </h2>
          <div className="mt-4 flex items-center justify-center gap-2">
            <span className="text-white/40">{b.subtitle1}</span>
            <span className="font-bold text-[#39ff14]">H2 ELEMENT</span>
            {b.subtitle2 && <span className="text-white/40">{b.subtitle2}</span>}
          </div>
        </div>

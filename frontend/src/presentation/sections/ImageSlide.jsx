 ...
 * md+: auto 112% + right/left. max-md: чуть меньше (105%) и сдвиг позиции — ближе к кадрированию ПК без «полоски» от чистого 112%.
 */
export function SplitImageSlide({ src, imageSide = 'right', bg = '#EAEAE5', children }) {
  ...
  const imageBgLayer =
    'absolute inset-0 bg-no-repeat max-md:bg-[length:auto_105%] md:bg-[length:auto_112%] ' +
    (imgOnRight

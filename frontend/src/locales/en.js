  ...
  slides: {
    ...
    slide4: {
      ...
      steps: [
        ...
        { num: '2', title: 'Injection', body: 'The HNO gas is supplied to the combustion chamber along with the air from the intake.' },
        { num: '3', title: 'Catalysis', body: 'The highly flammable HNO gas accelerates and enhances the combustion of the main fuel.' },
        { num: '4', title: 'Result', body: 'The fuel burns almost completely, increasing the thermal efficiency of the engine.' },
      ],
    },
    slide6before: 'Before',
    ...
    slide7: {
      ...
      engines: ['Gasoline', 'Diesel', 'Gas', 'Methane\n(incl. HBO)'],
      vehicles: ['Passenger Cars', 'Commercial Trucks', 'Agricultural Tractors', 'Special Equipment'],
